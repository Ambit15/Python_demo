...
def clip_rester(rester_file,clip_boundry,save_file):
    ...
    save_name = save_file + "\\" + keep_digits(rester_file) + "_clip.tif"
    ...
    # 指定裁剪操作的参数
    options = gd.WarpOptions(cutlineDSName=clip_boundry,cropToCutline=True,dstNodata=-1)  # 可以根据需要修改 nodata 值
